package com.omilen.agendaculturalbsas.loaders;
...
import com.omilen.agendaculturalbsas.AgendaCulturalBsAsActivity;
...
public class RESTLoader extends AsyncTaskLoader<RESTLoader.RESTResponse> {
	...
	public RESTResponse loadInBackground() {
		try {
			...
			if (mAction == null) {
				Log.e(AgendaCulturalBsAsActivity.TAG, "You did not define an action. REST call canceled.");
			...
			if (request != null) {
				...
				// in LogCat.
				Log.d(AgendaCulturalBsAsActivity.TAG, "Executing request: " + verbToString(mVerb) + ": " + mAction.toString());
				...
				RESTResponse restResponse = new RESTResponse(responseEntity != null ? EntityUtils.toString(responseEntity) : null,
						statusCode);
				return restResponse;
			}
			...
			Log.e(AgendaCulturalBsAsActivity.TAG, "URI syntax was incorrect. " + verbToString(mVerb) + ": " + mAction.toString(), e);
			return new RESTResponse();
		} catch (UnsupportedEncodingException e) {
			Log.e(AgendaCulturalBsAsActivity.TAG, "A UrlEncodedFormEntity was created with an unsupported encoding.", e);
			return new RESTResponse();
		} catch (ClientProtocolException e) {
			Log.e(AgendaCulturalBsAsActivity.TAG, "There was a problem when sending the request.", e);
			return new RESTResponse();
		} catch (IOException e) {
			Log.e(AgendaCulturalBsAsActivity.TAG, "There was a problem when sending the request.", e);
			return new RESTResponse();
	...
	private static void attachUriWithQuery(HttpRequestBase request, Uri uri, Bundle params) {
		try {
			...
			Log.e(AgendaCulturalBsAsActivity.TAG, "URI syntax was incorrect: " + uri.toString());
		}
	}
